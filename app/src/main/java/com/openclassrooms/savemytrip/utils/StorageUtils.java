...
public class StorageUtils {
    ...
    // This method return a text from the storage
    public static String getTextFromStorage(File rootDestination, Context context, String fileName,
                                            String folderName) {
        File file = createOrGetFile(rootDestination, fileName, folderName);
        return readOnFile(context, file);
    }

    // this method add text in storage
    public static void setTextInStorage(File rootDirection, Context context, String filname,
                                        String folderNAme, String text) {
        File file = createOrGetFile(rootDirection, filname, folderNAme);
    ...
    public static File getFileFromStorage(File rootDestination, Context context, String fileName,
                                          String folderName) {
